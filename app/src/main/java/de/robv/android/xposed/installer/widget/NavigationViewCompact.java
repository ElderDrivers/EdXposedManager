...
public class NavigationViewCompact extends NavigationView {
    ...
    public NavigationViewCompact(@NonNull Context context) {
        super(context);
    }

    public NavigationViewCompact(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public NavigationViewCompact(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    private void initView(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.NavigationViewCompact);
        selectedTextColor = a.getColor(R.styleable.NavigationViewCompact_itemSelectedTextColor, getResources().getColor(R.color.colorAccent));
        unSelectedTextColor = a.getColor(R.styleable.NavigationViewCompact_itemUnSelectedTextColor, getResources().getColor(R.color.tab_unselected_color));
        selectedIconColor = a.getColor(R.styleable.NavigationViewCompact_itemSelectedIconColor, getResources().getColor(R.color.colorAccent));
        unSelectedIconColor = a.getColor(R.styleable.NavigationViewCompact_itemUnSelectedIconColor, getResources().getColor(R.color.tab_unselected_color));
        a.recycle();
